...
{
    // Mirrors the deterministic direct-command grammar owned by Erenshor Follow. This class never moves
    // anything; Deep Sims uses it only to keep Follow-owned gameplay intent out of social generation.
